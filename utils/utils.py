...
def write_results(seq, all_tracks, output_dir, img_size):
        ...
        imgs_size = {'MOT16-01':(1920,1080),'MOT16-02':(1920,1080),'MOT16-03':(1920,1080),
                     ...
                     'Venice-1':(1920,1080),'KITTI-19':(1238,374),'KITTI-16':(1224,370),
                     ...
                     'MOT16-01-DPM':(1920,1080),'MOT16-02-DPM':(1920,1080),'MOT16-03-DPM':(1920,1080),
                     'MOT16-04-DPM':(1920,1080),'MOT16-05-DPM':(640,480),'MOT16-06-DPM':(640,480),
                     'MOT16-07-DPM':(1920,1080),'MOT16-08-DPM':(1920,1080),'MOT16-09-DPM':(1920,1080),
                     'MOT16-10-DPM':(1920,1080),'MOT16-11-DPM':(1920,1080),'MOT16-12-DPM':(1920,1080),
                     'MOT16-13-DPM':(1920,1080),'MOT16-14-DPM':(1920,1080),
                     'MOT16-01-FRCNN':(1920,1080),'MOT16-02-FRCNN':(1920,1080),'MOT16-03-FRCNN':(1920,1080),
                     'MOT16-04-FRCNN':(1920,1080),'MOT16-05-FRCNN':(640,480),'MOT16-06-FRCNN':(640,480),
                     'MOT16-07-FRCNN':(1920,1080),'MOT16-08-FRCNN':(1920,1080),'MOT16-09-FRCNN':(1920,1080),
                     'MOT16-10-FRCNN':(1920,1080),'MOT16-11-FRCNN':(1920,1080),'MOT16-12-FRCNN':(1920,1080),
                     'MOT16-13-FRCNN':(1920,1080),'MOT16-14-FRCNN':(1920,1080),
                     'MOT16-01-SDP':(1920,1080),'MOT16-02-SDP':(1920,1080),'MOT16-03-SDP':(1920,1080),
                     'MOT16-04-SDP':(1920,1080),'MOT16-05-SDP':(640,480),'MOT16-06-SDP':(640,480),
                     'MOT16-07-SDP':(1920,1080),'MOT16-08-SDP':(1920,1080),'MOT16-09-SDP':(1920,1080),
                     'MOT16-10-SDP':(1920,1080),'MOT16-11-SDP':(1920,1080),'MOT16-12-SDP':(1920,1080),
                     'MOT16-13-SDP':(1920,1080),'MOT16-14-SDP':(1920,1080)}
        ...
        file = osp.join(output_dir, seq+'.txt')
