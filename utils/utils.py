...
def write_results(seq, all_tracks, output_dir, img_size):
        ...
        imgs_size = {'MOT16-01':(1920,1080),'MOT16-02':(1920,1080),'MOT16-03':(1920,1080),
                     ...
                     'MOT17-01-DPM':(1920,1080),'MOT17-02-DPM':(1920,1080),'MOT17-03-DPM':(1920,1080),
                     'MOT17-04-DPM':(1920,1080),'MOT17-05-DPM':(640,480),'MOT17-06-DPM':(640,480),
                     'MOT17-07-DPM':(1920,1080),'MOT17-08-DPM':(1920,1080),'MOT17-09-DPM':(1920,1080),
                     'MOT17-10-DPM':(1920,1080),'MOT17-11-DPM':(1920,1080),'MOT17-12-DPM':(1920,1080),
                     'MOT17-13-DPM':(1920,1080),'MOT17-14-DPM':(1920,1080),
                     'MOT17-01-FRCNN':(1920,1080),'MOT17-02-FRCNN':(1920,1080),'MOT17-03-FRCNN':(1920,1080),
                     'MOT17-04-FRCNN':(1920,1080),'MOT17-05-FRCNN':(640,480),'MOT17-06-FRCNN':(640,480),
                     'MOT17-07-FRCNN':(1920,1080),'MOT17-08-FRCNN':(1920,1080),'MOT17-09-FRCNN':(1920,1080),
                     'MOT17-10-FRCNN':(1920,1080),'MOT17-11-FRCNN':(1920,1080),'MOT17-12-FRCNN':(1920,1080),
                     'MOT17-13-FRCNN':(1920,1080),'MOT17-14-FRCNN':(1920,1080),
                     'MOT17-01-SDP':(1920,1080),'MOT17-02-SDP':(1920,1080),'MOT17-03-SDP':(1920,1080),
                     'MOT17-04-SDP':(1920,1080),'MOT17-05-SDP':(640,480),'MOT17-06-SDP':(640,480),
                     'MOT17-07-SDP':(1920,1080),'MOT17-08-SDP':(1920,1080),'MOT17-09-SDP':(1920,1080),
                     'MOT17-10-SDP':(1920,1080),'MOT17-11-SDP':(1920,1080),'MOT17-12-SDP':(1920,1080),
                     'MOT17-13-SDP':(1920,1080),'MOT17-14-SDP':(1920,1080)}
